...
public class d12Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView text = (TextView) findViewById(R.id.d12Text);

        TextView randomNum = (TextView) findViewById(R.id.d12Value);

        randomNum.setText(String.format("%d", (int) (Math.random() * 12) + 1));
